...
def stubber(request):
    ...
    if exact_method:
        resp._content = bytes(json.dumps(exact_method.get("response")),
                              "utf-8")
...
JSON = {
        ...
        "GET": {
            "response": {
                ...
                "RequestedObject": {
                    ...
                    "Description":
                    "<html><head></head><pstyle=\"margin:0px\">NewGroup Description</p></html>",
                    "EveryoneFlag": False,
        ...
        "GET": {
            "response": [{
                ...
                "RequestedObject": {
                    ...
                    "Description":
                    "<html><head></head><pstyle=\"margin:0px\">WAS:NewGroup Description</p></html>",
                    "EveryoneFlag": False,
        ...
        "GET": {
            "response": [{
                ...
                "RequestedObject": {
                    ...
                    "Description":
                    "<html><head></head><pstyle=\"margin:0px\">TheAssetCatalog Administratorgroupisforuserswhohavefulladministrativeaccesstothefollowingcore applications:Applications,Devices,StorageDevices,Technologies,Business Processes,CorporateObjectives,ProductsandServices,InformationAssets,Facilities, andContacts.</p></html>",
                    "EveryoneFlag": False,
        ...
        "GET": {
            "response": [{
                ...
                "ValidationMessages": [{
                    ...
                    "ErroredValue": None,
                    "Validator":
                    "ArcherApi.Controllers.System.UserGroupController,ArcherApi, Version=6.2.100.1061,Culture=neutral,PublicKeyToken=None",
                    "XmlData": None,
        ...
        "GET": {
            "response": [{
                ...
                "RequestedObject": {
                    ...
                    "Description":
                    "Theexceptionrequest2requiresinputandsubmissiontothereviewer.",
                ...
                "RequestedObject": {
                    ...
                    "Description":
                    "Theexceptionrequest3requiresinputandsubmissiontothereviewer.",
    ...
    "/contentapi/Applications": {
        "GET": {
            "response": {
                "@odata.context":
                "localhost/contentapi/$metadata/$metadata#Risk_ Register",
                "value": [{
                    "Risk_Register_Id": 107826,
                    "Actual_Annualized_Loss_Amount": 0,
                    "Actual_Response_Date": None,
                    "Adjusted_Qual_Residual_Risk": ["NotRated"],
                    "Adjusted_Qual_Risk_Impact": ["NotRated"],
                    "Adjusted_Qual_Risk_Likelihood": ["NotRated"],
                    "Adjusted_Quantitative_Residual_Risk": ["NotRated"],
    ...
    "/contentapi/Incidents_Risks": {
        "GET": {
            "response": {
                "@odata.context":
                "localhost/contentapi/Incidents_ Risks/$metadata#Incidents_Risks",
                "value": [{
                    "Incidents_Id": 224931,
